...
public partial class ThumbService : IThumbService
{
    ...
    public virtual async Task DeletePictureThumbsAsync(Picture picture)
    {
        ...
        var currentFiles = _fileProvider.GetFiles(_fileProvider.Combine(_mediaSettings.ImagePath, NopMediaDefaults.ImageThumbsPath), filter, false);
    ...
    {
        var thumbsDirectoryPath = _fileProvider.Combine(_mediaSettings.ImagePath, NopMediaDefaults.ImageThumbsPath);
        ...
        if (_mediaSettings.MultipleThumbDirectories)
        {
            ...
            if (fileNameWithoutExtension != null && fileNameWithoutExtension.Length > NopMediaDefaults.MultipleThumbDirectoriesLength)
            {
                ...
                thumbsDirectoryPath = _fileProvider.Combine(_mediaSettings.ImagePath, NopMediaDefaults.ImageThumbsPath, subDirectoryName);

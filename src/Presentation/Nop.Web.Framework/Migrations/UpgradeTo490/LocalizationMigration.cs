...
public class LocalizationMigration : MigrationBase
{
    ...
    public override void Up()
    {
        ...
        localizationService.AddOrUpdateLocaleResource(new Dictionary<string, string>
        {
            ...
            //#7730
            ["Admin.Catalog.Products.AiGenerateFullDescription"] = "Generate product description by AI",
            ["Admin.Catalog.Products.AiFullDescription.Generate"] = "Generate description",
            ["Admin.Catalog.Products.AiFullDescription.ProductName"] = "Product name",
            ["Admin.Catalog.Products.AiFullDescription.ProductName.Hint"] = "Enter the product name, it'll took a part of generated description",
            ...
            ["ArtificialIntelligence.CrateProductFailed"] = "<p style='color:red'>The request to the artificial intelligence service ended with the \"<strong>{0}</strong>\" error, you can see the details in the <a href='/Admin/Log/List'>logs</a><p>",
            ...
            ["Admin.Configuration.Settings.Catalog.ArtificialIntelligence.ChatGptApiKey.Instruction"] = "<p>The ChatGPT API uses API keys for authentication. Create, manage, and learn more about API keys in your <a href='https://platform.openai.com/settings/organization/api-keys' target='_blank'>organization settings</a>.</p>",
            ["Admin.Configuration.Settings.Catalog.ArtificialIntelligence.DeepSeekApiKey.Instruction"] = "<p>To use the DeepSeek API, please <a href='https://platform.deepseek.com/api_keys' target='_blank'>create an API key</a> first.</p>",
            ["Enums.Nop.Core.ArtificialIntelligence.ToneOfVoiceType.Expert"] = "Expert",

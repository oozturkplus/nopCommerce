...
public partial class CommonModelFactory : ICommonModelFactory
{
    ...
    protected virtual async Task PrepareDeleteThumbFilesModelAsync(MaintenanceModel.DeleteThumbFilesModel model)
    {
        ...
        model.FilesCountText = string.Format(await _localizationService.GetResourceAsync("Admin.System.Maintenance.DeleteThumbsFiles.FilesCount"), filesCount);
        model.FilesSizeText = string.Format(await _localizationService.GetResourceAsync("Admin.System.Maintenance.DeleteThumbsFiles.FilesSize"), Math.Round(filesSize/1024M/1024M, 2));
    }
